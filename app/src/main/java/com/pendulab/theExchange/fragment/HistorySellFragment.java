 ...
 */
public class HistorySellFragment extends BaseFragment {

  public static HistorySellFragment instance;
  public static boolean firstTime;

  public static HistorySellFragment getInstance() {
    if (instance == null) {
      instance = new HistorySellFragment();
    }
    firstTime = true;
    return instance;
  }
  ...
  public void initData(View view) {
    ...
    adapter = new TransactionGroupAdapter(self, arrTransactionGroup, TransactionGroupAdapter.TYPE_SELL, new TransactionGroupAdapter.ITransactionGroup() {
      @Override
...
//        }
  ...
  private void getHistory() {
    List<NameValuePair> params = ParameterFactory.createGetTransactionHistoryParam(2);
