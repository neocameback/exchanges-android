...
/**
 * Created by Anh Ha Nguyen on 1/4/2016.
 */
public class TutorialItemDetailsActivity extends BaseShareActivity implements View.OnClickListener, ObservableScrollViewCallbacks {
  ...
  private void initShowcase() {
    ...
    if (currentItem != null) {
      if (currentItem.getOwnerId().equalsIgnoreCase(myAccount.getUserID())) {
        ...
        sequence.addSequenceItem(llOffer, getString(R.string.tut_make_an_offer), getString(R.string.tut_next));
      }
...
//                Toast.makeText(itemView.getContext(), "Item #" + position, Toast.LENGTH_SHORT).show();
  ...
  private void getItemDetails() {
    List<NameValuePair> params = ParameterFactory.createGetItemDetailsParams(itemID, applyLocationObj.getLatitude(), applyLocationObj.getLongitude());
  ...
  private void fillLayout() {
    ...
    currentItem.setTitle("Xbox 360");
    currentItem.setDescription("Xbox 360 demo item");
    currentItem.setPrice(100);
    currentItem.setImage(WebServiceConfig.TUTORIAL_IMAGE);
    currentItem.getArrImages().add(WebServiceConfig.TUTORIAL_IMAGE);
    currentItem.setDate(getString(R.string.tut_date));
    currentItem.setCategoryId("");
    currentItem.setDistance(1.5d);
    currentItem.setLocation("Singapore");
    currentItem.setLikeCount(5);
    currentItem.setCommnetCount(0);
    currentItem.setOwnerId("-1");
    currentItem.setOwnerImage("");
    currentItem.setOwnerUsername(getString(R.string.app_name));
    currentItem.setRate(0d);
...
//            });
  ...
  class CustomPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
      ...
      Glide.with(self).load(currentItem.getArrImages().get(position)).error(R.drawable.image_not_available).into(img);
...
//                DialogUtility.closeProgressDialog();
  ...
  private void showLikeSlider() {
    ...
    if (vsLike == null) {
      ...
      Drawable drBack = getResources().getDrawable(com.mikepenz.materialdrawer.R.drawable.abc_ic_ab_back_material);
      ...
      srlLike.setColorSchemeColors(ContextCompat.getColor(this, R.color.app_primary_color));
  ...
  private void showCommentSlider() {
    ...
    if (vsComment == null) {
      ...
      srlComment.setColorSchemeColors(ContextCompat.getColor(this, R.color.app_primary_color));
