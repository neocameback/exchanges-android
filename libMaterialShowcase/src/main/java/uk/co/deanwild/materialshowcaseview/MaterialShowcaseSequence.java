...
public class MaterialShowcaseSequence implements IDetachedListener {
    ...
    public Queue<MaterialShowcaseView> getmShowcaseQueue() {
        return mShowcaseQueue;
    }

    public void setmShowcaseQueue(Queue<MaterialShowcaseView> mShowcaseQueue) {
        this.mShowcaseQueue = mShowcaseQueue;
    }
